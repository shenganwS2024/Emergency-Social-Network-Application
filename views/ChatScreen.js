...
// Event listeners
document.getElementById('directory-button').addEventListener('click', navigateToDirectory)
document.getElementById('exit-chat').addEventListener('click', handleUserLogout)
document.getElementById('announcement').addEventListener('click', navigateToAnnouncement)
document.getElementById('search-btn').addEventListener('click', handleSearch)
document.getElementById('send-msg').addEventListener('click', sendMessage)

document.addEventListener('DOMContentLoaded', loadMessages)

// Function to navigate to the directory page
...
// Function to navigate to the announcement page
...
// Function to load messages on DOMContentLoaded
